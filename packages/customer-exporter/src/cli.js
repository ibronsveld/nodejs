...
import CustomerExporter from './main'
import { description } from '../package.json'

process.title = 'customer-exporter'
...
resolveCredentials(args)
  .then((credentials) => {
    ...
    return new CustomerExporter(exporterOptions)
  })
  .then((customerExporter) => customerExporter.run(args.output))
  .catch(errorHandler)
