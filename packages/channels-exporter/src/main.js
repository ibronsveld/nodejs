...
export default class ChannelsExporter {
  ...
  static fetchObjects(
    ...
    const request = ChannelsExporter.buildRequest(projectKey, predicate, expand)
  ...
  static buildRequest(projectKey: string, predicate: ?string, expand: Array<string>): ClientRequest {
    const uri = ChannelsExporter.buildUri(projectKey, predicate, expand)        
    return {
      uri,
      method: 'GET',
    }
