...
import OrderExporter from './main'
import { description } from '../package.json'

process.title = 'order-exporter'
...
resolveCredentials(args)
  .then((credentials) => {
    ...
    return new OrderExporter(exporterOptions)
  })
  .then((orderExporter) => orderExporter.run(args.output))
  .catch(errorHandler)
