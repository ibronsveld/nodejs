...
import PaymentsExporter from './main'
import { description } from '../package.json'

process.title = 'payments-exporter'
...
resolveCredentials(args)
  .then((credentials) => {
    ...
    return new PaymentsExporter(exporterOptions)
  })
  .then((paymentsExporter) => paymentsExporter.run(args.output))
  .catch(errorHandler)
